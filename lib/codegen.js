...
const prepareDir = () => {
    ...
    apiFile = config.apiPath
    serviceFile = config.servicePath
    serviceTestFile = config.utPath
...
const genApiCode = (data) => {
    genSourceCode(data, apiTmpl, apiFile)
}
...
const genServiceCode = (data) => {
    ...
    genSourceCode(data, serviceTmpl, serviceFile) // service source
    genSourceCode(data, testTmpl, serviceTestFile) // test code
}
